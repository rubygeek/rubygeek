...
return (new CustomEvent(event_name,(function (){var obj34736 = {"detail":data};
return obj34736;
})()));
} else {
...
var args34741 = [];
var len__25923__auto___34747 = arguments.length;
var i__25924__auto___34748 = (0);
while(true){
if((i__25924__auto___34748 < len__25923__auto___34747)){
args34741.push((arguments[i__25924__auto___34748]));

var G__34749 = (i__25924__auto___34748 + (1));
i__25924__auto___34748 = G__34749;
continue;
} else {
}
break;
...
var f = (function (){var pred__34744 = cljs.core._EQ_;
var expr__34745 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34744.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34745))){
return ((function (pred__34744,expr__34745){
return (function (p1__34737_SHARP_){
return console.warn(p1__34737_SHARP_);
});
;})(pred__34744,expr__34745))
} else {
if(cljs.core.truth_(pred__34744.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34745))){
return ((function (pred__34744,expr__34745){
return (function (p1__34738_SHARP_){
return console.debug(p1__34738_SHARP_);
});
;})(pred__34744,expr__34745))
} else {
if(cljs.core.truth_(pred__34744.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34745))){
return ((function (pred__34744,expr__34745){
return (function (p1__34739_SHARP_){
return console.error(p1__34739_SHARP_);
});
;})(pred__34744,expr__34745))
} else {
return ((function (pred__34744,expr__34745){
return (function (p1__34740_SHARP_){
return console.log(p1__34740_SHARP_);
});
;})(pred__34744,expr__34745))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34751){
...
var opts = map__34754__$1;
var eval_fn = cljs.core.get.call(null,map__34754__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34756_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__34758,(0),null);
...
var args34761 = [];
var len__25923__auto___34764 = arguments.length;
var i__25924__auto___34765 = (0);
while(true){
if((i__25924__auto___34765 < len__25923__auto___34764)){
args34761.push((arguments[i__25924__auto___34765]));

var G__34766 = (i__25924__auto___34765 + (1));
i__25924__auto___34765 = G__34766;
continue;
} else {
}
break;
...
//# sourceMappingURL=utils.js.map?rel=1533225034531