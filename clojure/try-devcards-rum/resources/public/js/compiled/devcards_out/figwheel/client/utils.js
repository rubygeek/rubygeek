...
return (new CustomEvent(event_name,(function (){var obj27744 = {"detail":data};
return obj27744;
})()));
} else {
...
var args27749 = [];
var len__25923__auto___27755 = arguments.length;
var i__25924__auto___27756 = (0);
while(true){
if((i__25924__auto___27756 < len__25923__auto___27755)){
args27749.push((arguments[i__25924__auto___27756]));

var G__27757 = (i__25924__auto___27756 + (1));
i__25924__auto___27756 = G__27757;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args27749.length)].join('')));
...
var f = (function (){var pred__27752 = cljs.core._EQ_;
var expr__27753 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27752.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27753))){
return ((function (pred__27752,expr__27753){
return (function (p1__27745_SHARP_){
return console.warn(p1__27745_SHARP_);
});
;})(pred__27752,expr__27753))
} else {
if(cljs.core.truth_(pred__27752.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27753))){
return ((function (pred__27752,expr__27753){
return (function (p1__27746_SHARP_){
return console.debug(p1__27746_SHARP_);
});
;})(pred__27752,expr__27753))
} else {
if(cljs.core.truth_(pred__27752.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27753))){
return ((function (pred__27752,expr__27753){
return (function (p1__27747_SHARP_){
return console.error(p1__27747_SHARP_);
});
;})(pred__27752,expr__27753))
} else {
return ((function (pred__27752,expr__27753){
return (function (p1__27748_SHARP_){
return console.log(p1__27748_SHARP_);
});
;})(pred__27752,expr__27753))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27759){
...
var eval_fn = cljs.core.get.call(null,map__27762__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27764_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__27766,(0),null);
var v = cljs.core.nth.call(null,vec__27766,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1538702790231